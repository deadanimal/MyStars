...
@section('content')
    ...
    <p>Welcome to My Stars!</p>

    <p>These terms and conditions outline the rules and regulations for the use of DCB Platform Limited's Website, located
        at https://www.stars.my.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use My Stars if you do
    ...
    <p>We employ the use of cookies. By accessing My Stars, you agreed to use cookies in agreement with the DCB Platform
        Limited's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, DCB Platform Limited and/or its licensors own the intellectual property rights for all
        material on My Stars. All intellectual property rights are reserved. You may access this from My Stars for your own
        personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from My Stars</li>
        <li>Sell, rent or sub-license material from My Stars</li>
        <li>Reproduce, duplicate or copy material from My Stars</li>
        <li>Redistribute content from My Stars</li>
    </ul>

    <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the <a
            href="https://www.termsfeed.com/terms-conditions-generator/">Terms and Conditions Generator</a>.</p>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
        of the website. DCB Platform Limited does not filter, edit, publish or review Comments prior to their presence on
        the website. Comments do not reflect the views and opinions of DCB Platform Limited,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, DCB Platform Limited shall not be liable for the Comments or for any liability, damages or expenses
        caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
        website.</p>

    <p>DCB Platform Limited reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant DCB Platform Limited a non-exclusive license to use, reproduce, edit and authorize others to use,
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of DCB Platform Limited;
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to DCB Platform Limited. Please include your name, your organization name,
    ...
    <p>No use of DCB Platform Limited's logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
