    ...
    <main class="page-wrapper">
      ...
      <div class="d-lg-flex position-relative h-100">
        ...
        <div class="d-flex flex-column align-items-center w-lg-50 h-100 px-3 px-lg-5 pt-5">
          <div class="w-100 mt-auto" style="max-width: 526px;">
            ...
            <form class="needs-validation" novalidate action="register" method="POST">
              ...
              <div class="row row-cols-1 row-cols-sm-2">
                <div class="col mb-4">
                  <input class="form-control form-control-lg" type="text" placeholder="Your name" name="name" required>
                </div>
                <div class="col mb-4">
                  <input class="form-control form-control-lg" type="email" placeholder="Email address" name="email" required>
                </div>
              </div>
          ...
          <!-- Copyright-->
          <p class="w-100 fs-sm pt-5 mt-auto mb-5" style="max-width: 526px;"><span class="text-muted">&copy; All rights reserved.</p>
        </div>
        <!-- Cover image-->
